							...
							<?php if(!empty($options['popups'])): ?>
								...
								<div class="sgpm-popup-options-container" data-sgpm-popup-id="<?php echo $popupId?>">
									...
									<div class="sgpm-popup-options">
										<a class="sgpm-action-label sgpm-btn blue" href="<?php echo SGPM_ADMIN_URL."admin.php?page=popup-maker-api-settings&popupId=".$popupId?>">Edit Settings <i class="dashicons dashicons-edit"></i>
										</a>
