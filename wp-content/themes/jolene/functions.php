...
?>
	<div class="site-info">
		<a href="<?php echo esc_url( __( 'http://wordpress.org/', 'jolene' )); ?>"><?php printf( __( 'Proudly powered by %s', 'jolene' ), 'WordPress' ); ?></a><?php esc_html( _e( ' theme by ', 'jolene' ) ); ?><a href="<?php echo esc_url( '#' ); ?>">WP Blogs</a>
	</div><!-- .site-info -->
